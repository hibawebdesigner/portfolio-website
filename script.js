...
"frontend":"Frontend",
"footer-text":"© 2026 Hiba • Frontend Developer",
"about-label":"Get TO KNOW ME",
"about-title":"About Me",
"about-subtitle":"Who I Am & What I Do",
"about-description":" I'm a  Frontend Developer passionate about building modern, responsive and user-friendly websites. I enjoy turning ideas into clean and elegant digital experiences using HTML, CSS, and JavaScript.",
"education":"Education",
"education-value":"Computer Engineering",
"location":"Location",
...
"responsive-text":"Beautiful and functional websites that work smoothy on desktop, tablet and mobile.",
...
"availability-text":"Available for freelancer work",
"your-name":"Your name",
...
"about-description":"Ich bin eine Frontend-Entwicklerin, die leidenschaftlich moderner, responsive und benutzerfreundliche Websites entwickele. Ich liebe es, Ideen in saubere und elegante digitale Erlebnisse zu verwandeln mit HTML, CSS und JavaScript.",
"education":"Ausbildung",
"education-value":"Technische Informatik",
"location":"Standort",
...
"clean-code-text":"Organisierter HTML, CSS und JavaScript mit Fokus auf Benutzerfreundlichkeit.",
...
"experience-value":"Expérience par projets",
"passion":"Passion",
...
"portfolio-sites-text":"Des sites modernes pour présenter professionellement les marques, les services et les entreprises.",
...
"availability-text":"Disponible pour des projets de freelance",
"your-name":"Votre nom",
...
"about-label":"CONOSCIAMICI",
"about-title":"Chi sono",
"about-subtitle":"Chi sono e cosa faccio",
"about-description":"Sono una sviluppatrice front-end appassionata della creazione di siti web moderni, reattivi e facili da usare. Adoro trasformare le idee in esperienze digitali eleganti e ben strutturate utilizzando HTML, CSS e JavaScript.",
"education":"Educazione",
"education-value":"Ingegneria informatica",
"location":"Localizzazione",
"location-value":"Siria",
"experience":"Esperienza",
"experience-value":"Esperienza su progetti",
"passion":"Passione",
"passion-value":"Esperienze web moderne",
"services-title":"COSA FACCIO",
"responsive-title":"Design adattivo",
...
"hero-description":" .أصمم وأطور مواقع حديثة ومتجاوبة بكود منظم وواجهات سهلة الاستخدام",
...
"responsive-design":"كمبيوتر • تابلت • موبايل",
"frontend":"تطوير الواجهات",
"footer-text":" © 2026 Hiba • مطوّرة واجهات أمامية ",
"about-label":"تعرّف عليّ",
"about-title":"من أنا",
"about-subtitle":"من أنا وماذا أفعل",
"about-description":"أنا مطورة واجهات أمامية شغوفة بإنشاء مواقع ويب حديثة وتفاعلية. أحب تحويل الأفكار إلى تجارب رقمية أنيقة ومُنظمة باستخدام HTML و CSS و JavaScript.",
"education":"التعليم",
...
"clean-code-text":"HTML و CSS و JavaScript منظمين مع التركيز على سهولة الاستخدام.",
...
"luxora-description":"موقع حديث لعيادة تجميل يضم حجز  المواعيد والعلاجات ضمن تصميم أنيق وعصري .",
